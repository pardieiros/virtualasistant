"""
Django settings for personalassistance project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'personalassistance'),
...
SOCKET_APP_KEY = os.getenv('SOCKET_APP_KEY', '')
SOCKET_APP_SECRET = os.getenv('SOCKET_APP_SECRET', '')
